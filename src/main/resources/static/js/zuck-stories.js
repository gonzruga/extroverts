...
let stories = new Zuck("stories", {
  ...
  stories: [
    ...
    Zuck.buildTimelineItem(
      ...
      timestamp(),
      [
        ["user2-story1", "photo", 5, "images/user.svg", "", '', false, false, timestamp()],
      ]
    ),
    ...
    Zuck.buildTimelineItem(
      ...
      timestamp(),
      [
        ["user3-story1", "photo", 5, "images/user.svg", "", '', false, false, timestamp()],
      ]
    ),
    ...
    Zuck.buildTimelineItem(
      ...
      timestamp(),
      [
        ["user4-story1", "photo", 5, "images/user.svg", "", '', false, false, timestamp()],
      ]
    ),
    ...
    Zuck.buildTimelineItem(
      ...
      timestamp(),
      [
        ["user5-story1", "photo", 5, "images/user.svg", "", '', false, false, timestamp()],
      ]
    ),
    ...
    Zuck.buildTimelineItem(
      ...
      timestamp(),
      [
        ["user6-story1", "photo", 5, "images/user.svg", "", '', false, false, timestamp()],
      ]
    ),
    ...
    {
      id: "user-7",               // story id
      photo: "images/user.svg",            // story photo (or user photo)
      name: "Your name here",             // story name (or user name)
      ...
      items: [              // array of items
        // Story item 
        {
          ...
          src: "images/user.svg",      // photo or video src
